                                ...
                                <div class="col-md-12">
                                    <div class="form-row">
                                        <div class="form-group col-md-6">
                                            ...
                                            <input type="text" name="first_name" class="myForn" placeholder="First Name" required>
                                        </div>
                                        <div class="form-group col-md-6">

                                            <input type="text"  name="last_name" class="myForn" placeholder="Last Name"  required>
                                        </div>

                                        <div class="form-group col-md-6">
                                            <input type="email"  name="email_id" class="myForn" placeholder="Email"  required>
                                        </div>
  <div class="form-group col-md-6">

                                            <input type="password"  name="password1" class="myForn" placeholder="Password"  required>
                                        </div>
                                        <div class="form-group col-md-6">
                                            <input type="password"   class="myForn" name="password2"  placeholder="Confirm Password"  required>
                                        </div>
                                        <div class="form-group col-md-6">

                                            <input type="text"  name="mobile_no" class="myForn" placeholder="Phone Number"  required>
                                        </div>
                                        ...
                                        <div class="form-group padding-top-10 col-md-12">
                                            <input style=background-color:white;color:#203566; type="submit" class="btn" name="register" value="Register"></input>
                                        </div>
